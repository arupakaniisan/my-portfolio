...
.nav-logo-input {
  ...
  border: 1px dashed rgba(0,229,160,.3);
  border-radius: 4px;
  outline: none;
...
.nav-logo-reset:hover {
  color: var(--accent);
  border-color: var(--accent);
}
.nav-logo.typing .nav-logo-input {
...
@media (max-width: 768px) {
  ...
  .nav-logo-input { width: min(52vw, 170px); }
  .nav-logo-reset { display: none; }
