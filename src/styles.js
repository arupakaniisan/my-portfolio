...
.nav-links a { font-size: 13px; color: var(--muted2); transition: color .2s; font-weight: 500; }
...
.mmenu {
  ...
  flex-direction: column; padding: 20px clamp(20px,5vw,60px); gap: 0;
}
.mmenu.open { display: flex; }
.mmenu a { font-size: 15px; color: var(--muted2); font-weight: 500; padding: 12px 0; border-bottom: 1px solid var(--border); }
.mmenu a:last-child { border-bottom: none; color: var(--accent); }
...
.hero h1 {
  font-size: clamp(38px, 8vw, 80px); font-weight: 700;
  line-height: 1.0; letter-spacing: -2px; margin-bottom: 8px;
}
.hero-accent { color: var(--accent); }
.hero-role {
  font-family: var(--mono); font-size: clamp(12px,2vw,15px);
  color: var(--muted); margin-bottom: 24px; letter-spacing: .5px;
}
.hero-desc {
  font-size: clamp(15px,2vw,17px); color: var(--muted2);
  max-width: 560px; font-weight: 300; line-height: 1.85; margin-bottom: 40px;
}
...
.abadge {
  ...
  border: 1px solid rgba(0,229,160,.2); border-radius: 3px;
...
/* ── PROJECTS ── */
.projs { display: flex; flex-direction: column; gap: 20px; }
.proj {
  background: var(--surface); border: 1px solid var(--border2);
...
.proj:hover { border-color: rgba(0,229,160,.4); transform: translateY(-2px); }
.proj-body { padding: 28px 32px; }
.proj-no { font-family: var(--mono); font-size: 11px; color: var(--muted); letter-spacing: 2px; margin-bottom: 12px; }
.proj-title { font-size: 20px; font-weight: 700; margin-bottom: 10px; letter-spacing: -.5px; }
.proj-desc { font-size: 14px; color: var(--muted2); line-height: 1.8; margin-bottom: 18px; font-weight: 300; }
...
.plink.primary { background: var(--accent); color: #0b0c0e; border-color: var(--accent); }
.plink.primary:hover { opacity: .85; }
.plink.dim { opacity: .4; cursor: default; }
.proj-vis {
...
.vis-icon { font-size: 40px; opacity: .12; }
.vis-label { font-family: var(--mono); font-size: 10px; color: var(--muted); opacity: .4; letter-spacing: 2px; }

/* アーキテクチャ図 */
.arch { width: 100%; padding: 24px; display: flex; flex-direction: column; gap: 10px; }
.arch-label { font-family: var(--mono); font-size: 10px; color: var(--muted); letter-spacing: 1.5px; margin-bottom: 4px; }
...
.abox.green { border-color: rgba(0,229,160,.35); color: var(--accent); background: var(--accent-dim); }
.abox.blue  { border-color: rgba(59,130,246,.35); color: var(--accent2); background: var(--accent2-dim); }
.abox.sm    { font-size: 9px; }
.aarrow { color: var(--muted); font-size: 11px; flex-shrink: 0; }
.arch-code {
  margin-top: 8px; padding: 10px 12px;
  background: var(--accent-dim); border-radius: 5px;
  border: 1px solid rgba(0,229,160,.15);
  font-family: var(--mono); font-size: 10px; color: var(--muted2); line-height: 1.8;
}
.arch-code .cl { color: var(--accent); display: block; margin-bottom: 2px; }
...
.soc {
  ...
  background: var(--surface); border: 1px solid var(--border2);
  border-radius: 8px; font-size: 14px; color: var(--muted2); transition: all .2s;
}
.soc:hover { border-color: var(--accent); color: var(--accent); }
.soc-badge {
  font-family: var(--mono); font-size: 10px; background: var(--surface2);
  border: 1px solid var(--border2); padding: 3px 7px; border-radius: 3px; letter-spacing: 1px; flex-shrink: 0;
}
...
.form-btn {
  ...
  font-family: var(--sans); transition: opacity .2s; letter-spacing: .3px;
}
.form-btn:hover { opacity: .85; }
.form-sent {
  padding: 40px; text-align: center;
  background: var(--surface); border: 1px solid rgba(0,229,160,.2); border-radius: 8px;
}
...
/* ── FOOTER ── */
.footer {
  border-top: 1px solid var(--border); padding: 24px clamp(20px,5vw,60px);
  max-width: 1000px; margin: 0 auto;
...
@media (max-width: 768px) {
  ...
  .proj-vis { min-height: 180px; border-left: none; border-top: 1px solid var(--border2); }
